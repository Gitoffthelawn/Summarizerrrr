<script>
  ...
  import SaveToArchiveFromHistoryButton from '@/entrypoints/archive/components/SaveToArchiveFromHistoryButton.svelte'
  ...
  import DeepDiveQuestionsArchive from '@/entrypoints/archive/components/DeepDiveQuestionsArchive.svelte'
  import {
