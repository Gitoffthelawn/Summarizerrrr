<script>
  // @ts-nocheck
  import YouTubeSummaryDisplayFP from '@/entrypoints/content/components/displays/YouTubeSummaryDisplayFP.svelte'
  import CourseSummaryDisplayFP from '@/entrypoints/content/components/displays/CourseSummaryDisplayFP.svelte'
  import GenericSummaryDisplayFP from '@/entrypoints/content/components/displays/GenericSummaryDisplayFP.svelte'
