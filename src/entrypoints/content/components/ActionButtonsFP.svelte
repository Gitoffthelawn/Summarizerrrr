<script>
  ...
  import ShadowTooltip from '@/entrypoints/content/components/ShadowTooltip.svelte'
  import { t } from 'svelte-i18n'
  import { ShadowTooltipState } from '@/entrypoints/content/components/shadowTooltipState.svelte.js'
