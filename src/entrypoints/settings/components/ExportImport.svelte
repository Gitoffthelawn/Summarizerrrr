<script>
  ...
  import SwitchPermission from '@/entrypoints/settings/components/inputs/SwitchPermission.svelte'
  ...
  import PreviewData from '@/entrypoints/settings/components/ui/PreviewData.svelte'
  import 'overlayscrollbars/overlayscrollbars.css'
  import { useOverlayScrollbars } from 'overlayscrollbars-svelte'
  import Preview from '@/entrypoints/settings/components/ui/Preview.svelte'
  import ConfirmDialog from '@/entrypoints/settings/components/ui/ConfirmDialog.svelte'
