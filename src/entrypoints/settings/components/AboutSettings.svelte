<script>
  ...
  import Logo from '@/entrypoints/settings/components/ui/Logo.svelte'
  import packageJson from '../../../../package.json'
  import ButtonSupport from '@/entrypoints/settings/components/buttons/ButtonSupport.svelte'
  import ButtonRate from '@/entrypoints/settings/components/buttons/ButtonRate.svelte'
