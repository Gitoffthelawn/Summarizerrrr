<!-- @ts-nocheck -->
<script>
  import Version from '@/entrypoints/settings/components/ui/version.svelte'
  import packageJson from '../../../../package.json'
  import LogoColor from '@/entrypoints/settings/components/ui/Logo-color.svelte'
  import Pivot from '@/entrypoints/settings/components/ui/Pivot.svelte'
