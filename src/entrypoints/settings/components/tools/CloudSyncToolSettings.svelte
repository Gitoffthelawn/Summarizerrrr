<script>
  ...
  import CloudSyncUserCard from '@/entrypoints/settings/components/cloudsync/CloudSyncUserCard.svelte'
  import SettingsConflictDialog from '@/entrypoints/settings/components/cloudsync/SettingsConflictDialog.svelte'
  import TextInput from '@/entrypoints/settings/components/inputs/TextInput.svelte'
