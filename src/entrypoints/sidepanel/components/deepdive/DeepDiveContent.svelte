<script>
  ...
  import CustomQuestionInput from '@/entrypoints/sidepanel/components/deepdive/CustomQuestionInput.svelte'

  import ChatProviderSelect from '@/entrypoints/sidepanel/components/deepdive/ChatProviderSelect.svelte'
