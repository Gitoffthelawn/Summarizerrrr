<script>
  ...
  // Re-measure when the value changes from outside (e.g. skill starter prompt).
  $effect(() => {
    value
    autoResize()
  })
...
<div
  class="chat-composer-input w-full py-1.5 rounded-[1.625rem] pl-11 pr-14 bg-surface-2 flex items-center border border-muted/30 overflow-y-auto"
>
